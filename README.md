...
*  **Catálogo Dinâmico de Obras:** Exposição de 10 quadros/obras temáticas. Utiliza injeção de dependência via Controller para renderizar diferentes obras em uma **única View genérica**, otimizando o reuso de código e memória.
